...
export const ONBOARDING_STEPS: StepDef[] = [
  ...
  { id: "subscription", path: "/onboarding/subscription", label: "Choose a plan", group: "Build" },
  { id: "connections", path: "/onboarding/connections", label: "Connect platforms", group: "Configure" },
