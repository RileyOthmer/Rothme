...
export const Route = createFileRoute("/design")({
  head: () => ({
    meta: [
      { title: "Design system — ROTHME" },
      {
        name: "description",
        content:
          "Living reference for the ROTHME design system: tokens, typography, and every reusable component in light and dark mode.",
      },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <footer className="border-t border-border py-8">
        <div className="mx-auto max-w-6xl px-4 text-xs text-muted-foreground sm:px-6">
          ROTHME design system · Living reference
        </div>
      </footer>
    </div>
  );
